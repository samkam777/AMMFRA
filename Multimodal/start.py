...
def fun4(num):
    os.system('python /huanggx/fullmodal/code/Multimodal/main_V2.py --exp "main_V2" --_running_time ' + running_time)
...
if __name__ == '__main__':
    ...
    main = multiprocessing.Process(target=fun4, args=(5,))
    main_only_txt = multiprocessing.Process(target=fun5, args=(5,))
    main_only_img = multiprocessing.Process(target=fun6, args=(5,))
    main_only_transformer = multiprocessing.Process(target=fun8, args=(5,))
