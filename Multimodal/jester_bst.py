...
class MovieDataset(Dataset):
    def __init__(self, ratings_file, test=False):
        ...
        self.txt_feature_df = pd.read_csv(data_path + "/Jester/Jester_txt_feature.csv")
...
def get_data(batch_size):
    ...
    train_dataset = MovieDataset(data_path + "/Jester/train_data.csv")
    # train_dataset = MovieDataset(data_path + "/train_data.csv")
    val_dataset = MovieDataset(data_path + "/Jester/val_data.csv")
    test_dataset = MovieDataset(data_path + "/Jester/test_data.csv")
...
class BST(nn.Module):
    ...
    def encode_input(self, inputs):
        ...
        user_id, movie_history, target_movie_id, movie_history_ratings, target_movie_rating, target_movie_id_txt_feature= inputs
