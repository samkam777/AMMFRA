...
def main():
    ...
    # hyper-parameter
    hyper_param = "_user_" + str(args.n_users) + "_algorithm_" + str(args.algorithm) + "_DP_" + str(args.if_DP) + "_noise_" + str(args.noise_multiplier) + "_attack_" + str(args.attack_rate) + "_"
    ...
    tensorboard_path = "/huanggx/0002code/multi_FL_attack_V2/" + running_time + "/" + hyper_param + "/" + "tensorboard/"
