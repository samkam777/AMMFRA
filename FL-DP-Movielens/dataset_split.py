...
def get_data(args):
    ...
    local_train_datasets = dataset_split(train_dataset, args.n_users, balance=args._balance, path=data_path + "/new_dataset4/train_data.csv", shuffle_l=shuffle_l)
    local_val_datasets = dataset_split(val_dataset, args.n_users, balance=args._balance, path=data_path + "/new_dataset4/val_data.csv", shuffle_l=shuffle_l)
    local_test_datasets = dataset_split(test_dataset, args.n_users, balance=args._balance, path=data_path + "/new_dataset4/test_data.csv", shuffle_l=shuffle_l)
...
def dataset_split(dataset, n_workers, balance, path, shuffle_l = None):
    ...
    # shuffle_l = shuffle_list(n_user, n_workers, 100)   
